...
// ── 주요 목록 페이지 ──
emit('/schools', '미국 명문대 합격률·합격 전략 — 대학 144+ 공식 데이터 | 미국 대입 로드맵',
  '미국 대학 144곳의 합격률·국제학생 합격률·SAT 중간 50%·보충 에세이·장학금을 공식 출처(CDS)로만 정리 — 종합대 톱 100 + 리버럴 아츠 칼리지 35곳 + 미술·디자인 전문학교 8곳.')
