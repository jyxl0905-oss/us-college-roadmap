...
emit('/majors/trends', '미국 대학 전공 트렌드 — 인기 전공·뜨는 전공·취업 잘되는 전공 (공식 통계) | 미국 대입 로드맵',
  '미 교육부 통계청(NCES) 학사 학위 수로 본 인기·성장·감소 전공과, 뉴욕 연방준비은행 자료로 본 전공별 최근 졸업생 실업률·불완전 취업·초봉, 덜 알려졌지만 지표가 좋은 전공을 정리했어요.')
emit('/about', '서비스 소개·데이터 출처와 원칙 | 미국 대입 로드맵',
  '한국 국제학교 학생을 위한 무료 미국 대입 관리 툴 — Common Data Set·각 대학 공식 입학처·College Board·NCES·BLS 등 공식 출처만 쓰고, 확인 못 한 값은 비워 두며, 합격 확률을 예측하지 않는 원칙을 소개해요.')
emit('/privacy', '개인정보처리방침 | 미국 대입 로드맵', '미국 대입 로드맵이 수집하는 정보, 이용 목적, 판매·광고 없음, 보관과 삭제, 만 13세 미만 정책을 안내해요.')
emit('/terms', '이용약관 | 미국 대입 로드맵', '무료 미국 대입 정보·기록 도구인 미국 대입 로드맵의 이용약관이에요.')
