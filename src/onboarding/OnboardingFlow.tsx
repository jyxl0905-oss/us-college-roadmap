      ...
      case 'targetMode':
        return (
          <ChoiceStep
            ...
            options={[
              { value: 'schools', label: t('구체적인 학교가 있어요', 'Yes, specific schools'), description: t('종합대 톱100 + 리버럴 아츠 35곳 + 미술·디자인 전문학교 11곳에서 검색해요', 'Search the top 100 universities + 35 LACs + 11 art & design schools') },
      ...
      case 'targetSchools':
        return (
          <TargetSchoolsStep
            ...
            onNext={goNext}
            majors={[answers.majorPrimary, answers.majorSecondary]}
          />
        )
      case 'targetTier':
        return (
