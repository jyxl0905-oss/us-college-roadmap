    ...
    <div className={selectedIds.length > 0 ? 'pb-24' : ''}>
      ...
      {!q && artRecs.length > 0 && (
        <div className="mt-4 rounded-xl border border-pink-200 bg-pink-50 p-3">
          ...
          <p className="mt-0.5 text-xs text-pink-800">{t('이 전공을 공식 개설한 미술·디자인 전문학교예요. 눌러서 목표에 담을 수 있어요.', 'Art & design schools that officially offer this major. Tap to add.')}</p>
