...
export const majorCategories: MajorCategory[] = [
  ...
  { value: 'nuclear_eng', label: '원자력공학 (Nuclear Engineering)', track: 'stem' },
  { value: 'robotics', label: '로보틱스 (Robotics)', track: 'stem' },
  ...
  { value: 'marine_biology', label: '해양생물학 (Marine Biology)', track: 'stem' },
  ...
  { value: 'geology', label: '지질학 (Geology)', track: 'stem' },
  { value: 'earth_science', label: '지구과학 (Earth Science)', track: 'stem' },
  ...
  { value: 'archaeology', label: '고고학 (Archaeology)', track: 'liberal' },
...
export const majorAlias: Record<string, string> = {
  ...
  astronomy: 'physics',
  geology: 'natural_sci',
  earth_science: 'natural_sci',
  archaeology: 'social_sci',
  pre_vet: 'premed',
  history: 'humanities',
  english: 'humanities',
  ...
  pharmacy: 'premed',
  pre_dental: 'premed',
  nuclear_eng: 'engineering',
  robotics: 'engineering',
  pilot: 'aerospace_eng',
  political_sci: 'social_sci',
  intl_relations: 'social_sci',
  criminology: 'social_sci',
  criminal_psych: 'psychology',
...
export const majorClusters: MajorCluster[] = [
  ...
  { track: 'stem', ko: '자연과학', en: 'Natural Sciences', values: ['natural_sci', 'biology', 'genetics', 'molecular_bio', 'microbiology', 'zoology', 'marine_biology', 'animal_science', 'animal_behavior', 'neuroscience', 'chemistry', 'physics', 'astronomy', 'environmental', 'geology', 'earth_science'] },
  ...
  { track: 'liberal', ko: '인문·언어', en: 'Humanities & Language', values: ['humanities', 'history', 'archaeology', 'english', 'linguistics', 'philosophy'] },
